...
class PurchaseOrderRepository extends BaseRepository
{
    ...
    public function store($input)
    {
        ...
        $estimate = PurchaseOrder::create($this->prepareEstimateData($input));
    ...
    public function storeTerms($id, $input)
    {
        ...
        PurchaseOrderTerm::where('estimate_id', $id)->delete();
        ...
        if (!empty($estimateTerms)) {
            PurchaseOrderTerm::insert($estimateTerms);
        }
    }
    ...
    public function prepareEstimateData($input)
    {
        ...
        $estimateFields = (new PurchaseOrder())->getFillable();
        $items = [];
    ...
    {
        activity()->performedOn($estimate)->causedBy(getLoggedInUser())
            ->useLog('Estimate deleted.')->log( ' Order deleted.');
