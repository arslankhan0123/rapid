...
class PurchaseInvoiceController extends AppBaseController
{
    ...
    public function create($customerId = null)
    {
        ...
        return view('purchase-invoices.create', compact('data', 'services', 'customerId', 'settings', 'nextNumber', 'terms', 'categories', 'groups', 'purchaseCategories', 'subcategories', 'units', 'paymentModes'));
    }
    ...
    public function show(PurchaseInvoice $invoice)
    {
        ...
        // dd($estimate->toArray());
        return view("purchase-invoices.views.$groupName", compact('estimate', 'status', 'priorities', 'groupName', 'totalIncludingVAT', 'totalExcludingVAT', 'totalVATAmount', 'totalDiscount', 'totalNetAmount', 'afterDiscount', 'words', 'newVat', 'newTotal'));
    }
    ...
    public function edit(PurchaseInvoice $invoice)
    {
        ...
        $units = $this->purchaseItemRepository->getUnits();
        $paymentModes = $this->purchaseItemRepository->getPaymentModes();
        return view('purchase-invoices.edit', compact('customer', 'data', 'services', 'estimate', 'addresses', 'terms', 'categories', 'groups', 'purchaseCategories', 'subcategories', 'units', 'paymentModes'));
    }
