...
class PurchaseReturnController extends AppBaseController
{
    ...
    public function create($customerId = null)
    {
        ...
        return view('purchase-returns.create', compact('data', 'services', 'customerId', 'settings', 'nextNumber', 'terms', 'categories', 'groups', 'purchaseCategories', 'subcategories', 'units'));
    }
    ...
    public function show(PurchaseReturn $return)
    {
        ...
        // dd($estimate->toArray());
        return view("purchase-returns.views.$groupName", compact('estimate', 'status', 'priorities', 'groupName', 'totalIncludingVAT', 'totalExcludingVAT', 'totalVATAmount', 'totalDiscount', 'totalNetAmount', 'afterDiscount', 'words', 'newVat', 'newTotal'));
    }
    ...
    public function edit(PurchaseReturn $return)
    {
        ...
        $estimate = $return;
        return view('purchase-returns.edit', compact('customer', 'estimate', 'data', 'services', 'estimate', 'addresses', 'terms', 'categories', 'groups', 'purchaseCategories', 'subcategories', 'units'));
    }
