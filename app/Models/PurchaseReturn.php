 ...
 */
class PurchaseReturn extends Model implements Taggable
{
    ...
    {
        return $this->hasMany(PurchaseReturnTerm::class, 'purchase_return_id');
    }
    ...
    {
        return $this->hasMany(PurchaseReturnDoc::class);
    }
}
