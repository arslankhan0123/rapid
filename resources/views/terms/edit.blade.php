                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 mb-0">
                            ...
                            {{ Form::textarea('terms', $term->terms, ['class' => 'form-control summernote-simple', 'id' => 'createDescription', 'required']) }}
                        </div>
                    </div>
