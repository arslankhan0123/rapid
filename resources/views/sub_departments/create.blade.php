@extends('layouts.app')
@section('title')
    {{ __('messages.department.add_sub_department') }}
@endsection
@section('page_css')
...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.department.add_sub_department') }}</h1>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    {{ Form::label('title', __('messages.department.sub_departments') . ':') }}<span
                                        class="required">*</span>
                                ...
                                <div class="form-group col-sm-12 mb-0">
                                    {{ Form::label('description', __('messages.department.description') . ':') }}
...
@section('scripts')
    ...
    <script>
        let departmentNewCreateUrl = route('sub_departments.store');
        ...
        $(document).on('click', '.edit-btn', function(event) {
            ...
            const url = route('departments.edit', id);
            window.location.href = url;
        });

        $(document).on('click', '.delete-btn', function(event) {
            let departmentId = $(event.currentTarget).data('id');
            deleteItem(route('departments.destroy', departmentId), '#designationTable',
