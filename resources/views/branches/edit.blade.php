...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.branches.edit') }}</h1>
            <div class="section-header-breadcrumb float-right">
                <div class="card-header-action mr-3 select2-mobile-margin">
                </div>
            </div>
            <div class="float-right">
                <a href="{{ route('branches.index') }}" class="btn btn-primary form-btn">
                    {{ __('messages.branches.list') }}</a>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    ...
                    {{ Form::hidden('id', $branch->id, ['id' => 'supplier_id']) }}
                    @include('branches.edit_fields')
                    {{ Form::close() }}
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.fileDeleteBtn', function(event) {
                ...
                swal({
                    ...
                    function() {
                        deleteItemAjax(route('branches.file.delete', fileId),
                            "Document", row, null);
                    });
