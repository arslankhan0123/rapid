<ul class="nav nav-tabs mb-3" id="customerTab" role="tablist">
    ...
    {{-- <li class="nav-item">
        <a href="{{ route('customers.show',['customer' => $customer->id, 'group' => 'contracts']) }}"
           class="nav-link {{ (isset($groupName) && $groupName == 'contracts') ? 'active' : ''}}">
            {{ __('messages.contracts') }}
        </a>
    </li> --}}
    <li class="nav-item">
        <a href="{{ route('customers.show',['customer' => $customer->id, 'group' => 'expenses']) }}"
           class="nav-link {{ (isset($groupName) && $groupName == 'expenses') ? 'active' : ''}}">
