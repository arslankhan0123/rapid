@extends('layouts.app')
@section('title')
    {{ __('messages.purchase-categories.add') }}
@endsection
@section('page_css')
...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.purchase-categories.add') }}</h1>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            {{ Form::label('purchase_group_id', __('messages.common.groups') . ':') }}<span class="required">*</span>
...
@section('scripts')
    ...
    <script>
        let categoryCreateUrl = route('purchase-categories.store');
