@extends('layouts.app')
@section('title')
    {{ __('messages.purchase-invoices.add') }}
@endsection
@section('page_css')
...
@section('content')
    <section class="section">
        <div class="section-header " style="height: 55px;margin-bottom:5px;">
            <h1>{{ __('messages.purchase-invoices.add') }}</h1>
            <div class="section-header-breadcrumb">
                <a href="{{ route('purchase-invoices.index') }}" class="btn btn-primary form-btn float-right-mobile">
        ...
        <div class="section-body">
            ...
            <div class="card">
                {{ Form::open(['route' => 'purchase-invoices.store', 'validated' => false, 'id' => 'orderForm']) }}
    ...
    <script>
        $(document).ready(function() {
            $('#btnSave').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('purchase-invoices.store') }}', // Route for the store method
                    type: 'POST',
                    data: formData,
