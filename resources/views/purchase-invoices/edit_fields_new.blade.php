...
<div class="form-group col-md-2 col-sm-12">
    ...
    {{ Form::select('branch_id', $usersBranches ?? [], $estimate->branch_id ?? null, [
        ...
        <div class="form-group  col-md-2 col-sm-6">
            ...
            <input type="text" class="form-control state" disabled
                value="{{ $customer->supplierState->name ?? '' }}">
        </div>
        <div class="form-group  col-md-2 col-sm-6">
    ...
    @include('purchase-invoices.edit_terms_modal')
    @include('purchase-invoices.edit_address_modal')
    @include('purchase-invoices.edit_document_modal')
    @include('purchase-invoices.createItem')
    @include('purchase-invoices.edit_items_new')
                        ...
                        <tbody>
                            @foreach ($estimate->documents as $document)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ asset('uploads/public/purchase_invoice_docs/' . basename($document->file)) }}"
