@extends('layouts.app')
@section('title')
    {{ __('messages.supplier_groups.add') }}
@endsection
@section('page_css')
...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.supplier_groups.add') }}</h1>
            <div class="section-header-breadcrumb float-right">
                <div class="card-header-action mr-3 select2-mobile-margin">
                </div>
            </div>
            <div class="float-right">
                <a href="{{ route('supplier-groups.index') }}" class="btn btn-primary form-btn">
                    {{ __('messages.supplier_groups.list') }}</a>
            </div>
        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 mb-0">
                                    {{ Form::label('description', __('messages.supplier_groups.description') . ':') }}
...
@section('scripts')
    ...
    <script>
        let departmentNewCreateUrl = route('supplier-groups.store');
