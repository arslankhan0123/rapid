<div class="card-body pt-1">
    ...
    <div class="row  ">
        ...
        <div class="form-group  col-md-2 col-sm-6 ">
            ...
            <input type="text" value="{{ $nextNumber }}" class="form-control" readonly name="return_number">
        </div>
        <div class="form-group  col-md-2 col-sm-6">
            {{ Form::label('estimate_number', 'Purchase Invoice Number') }}
            {{ Form::text('purchase_invoice_id', null, ['class' => 'form-control', 'required', 'id' => 'purchaseInvoiceNumber']) }}
        </div>

        <div class="form-group  col-md-2 col-sm-6">
            {{ Form::label('estimate_number', 'P.O Number') }}
            {{ Form::text('po_number', null, ['class' => 'form-control', 'required', 'id' => 'estimateNumber', 'readonly']) }}
        </div>
    <div class="form-group col-md-2 col-sm-6">
    ...
    <select name="branch_id" id="branch_id" class="form-control" required>
        ...
        <div class="form-group  col-md-2 col-sm-6">
            ...
            <div class="input-group">
                ...
                {{ Form::text('estimate_date', null, ['class' => 'form-control datepicker', 'id' => 'estimate_date', 'required', 'autocomplete' => 'off']) }}
            </div>
        </div>
