            ...
            <table class="sales_info">
                ...
                <tr>
                    ...
                    <td style="max-width: 100px;">
                        {{ $estimate->customer?->supplierCountry?->name ?? '' }}
                    </td>
            ...
            <table class="sales_table_data"
                ...
                <thead>
                    <tr>
                        ...
                        <th style="border: 1px solid #848484;  text-align:center; padding:0px;">Item<br> Name
                        </th>
                    ...
                    @foreach ($estimate->salesItems as $index => $item)
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                {{ html_entity_decode($item->service->name) }}</td>
