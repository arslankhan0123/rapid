...
@section('section')
        ...
        <div class="d-flex justify-content-end align-items-center">
            <div class="dropdown d-inline">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="{{ route('purchase-orders.pdf', ['order' => $estimate->id]) }}" class="dropdown-item">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            {{ Form::label('estimate_number', __('messages.purchase-orders.order_number')) }}
            <p>{{ $estimate->estimate_number }}</p>
        </div>
        <div class="form-group col-md-4">
            {{ Form::label('estimate_date', __('messages.purchase-orders.order_date')) }}
