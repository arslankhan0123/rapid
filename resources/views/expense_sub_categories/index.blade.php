        ...
        <div class="section-header item-align-right">
            ...
            <div class="section-header-breadcrumb float-right">
                <div class="card-header-action mr-3 select2-mobile-margin">
                    {{ Form::select('expense_category', $expenseCategories, null, ['id' => 'expCategory', 'class' => 'form-control select2', 'style' => 'max-width:300px', 'placeholder' => __('messages.placeholder.select_expanse_category')]) }}
                </div>
            </div>
