...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.employees.name') }}</h1>
            ...
            @can('create_employees')
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <div class="float-right">
                        <a href="{{ route('employees.create') }}" class="btn btn-primary" style="line-height: 30px;">
...
@section('scripts')
    ...
    <script>
        ...
        $('#exportButton').on('click', function() {
            ...
            let exportUrl = `{{ route('employees.export', ['status' => ':status', 'branch' => ':branch']) }}`;
            exportUrl = exportUrl.replace(':status', selectedStatus);

            if (branchId) {
                exportUrl = exportUrl.replace(':branch', branchId);
            } else {
                // Remove '/:branch' entirely if branchId is not provided
