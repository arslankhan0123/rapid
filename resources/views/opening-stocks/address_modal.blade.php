            ...
            <div class="modal-body">
                ...
                <div class="row" id="addressForm">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        {{ Form::text('zip_code[]', isset($addresses[0]->zip_code) ? $addresses[0]->zip_code : null, ['class' => 'form-control zip-code', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'id' => 'billZipCode']) }}
                    </div>
                    <div class="form-group col-sm-12 col-md-6">
                ...
                <div id="shippingAddressForm" class="display-none">
                    ...
                    <div class="row" id="addressForm">
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            {{ Form::label('zip_code',__('messages.address.zip_code').':') }}
                            {{ Form::text('zip_code[]', isset($addresses[1]->zip_code) ? $addresses[1]->zip_code : null, ['class' => 'form-control zip-code','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id' => 'shipZipCode']) }}
                        </div>
                        <div class="form-group col-sm-12 col-md-6">
                            {{ Form::label('country',__('messages.address.country').':') }}
                ...
                <div class="text-right modal-footer">
                    <button type="button" class="btn btnSecondary text-white" id="btnCancel"
                        data-dismiss="modal">{{ __('messages.common.cancel') }}</button>
                    <button type="button" id="btnSaveEstimateAddress" class="btn btn-primary"
                        style="line-height: 30px;">{{ __('messages.common.save') }}</button>
