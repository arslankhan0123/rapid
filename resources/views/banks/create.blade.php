                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            {{ Form::label('title', __('messages.banks.bank_name')) }}<span class="required">*</span>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            {{ Form::text('account_number', null, ['class' => 'form-control', 'required', 'autocomplete' => 'off']) }}
                        </div>
                        <div class="form-group col-sm-12">
                            {{ Form::label('title', __('messages.banks.branch_name')) }}
                            {{ Form::text('branch_name', null, ['class' => 'form-control', 'autocomplete' => 'off']) }}
                        </div>
                        <div class="form-group col-sm-12">
                            {{ Form::label('title', __('messages.banks.iban_number')) }}<span class="required">*</span>
                            {{ Form::text('iban_number', null, ['class' => 'form-control', 'required', 'autocomplete' => 'off']) }}
                        </div>
                        <div class="form-group col-sm-12">
                            {{ Form::label('title', __('messages.banks.opening_balance')) }}<span class="required">*</span>
                            {{ Form::number('opening_balance', null, ['class' => 'form-control', 'required', 'autocomplete' => 'off', 'step' => 'any']) }}
                        </div>
                        <div class="form-group col-sm-12">
                            {{ Form::label('title', __('messages.banks.address')) }}
                            {{ Form::textarea('address', null, ['class' => 'form-control', 'autocomplete' => 'off']) }}
                        </div>
...
@section('scripts')
    ...
    <script>
        let departmentNewCreateUrl = route('banks.store');
