...
<div class="row">
    <div class="form-group col-sm-12">
        ...
        {{ Form::text('certificate_number', $nextNumber, ['class' => 'form-control', 'required', 'id' => 'transfer_id', 'autocomplete' => 'off', 'readonly']) }}
    </div>
    <div class="form-group  col-sm-12">
    ...
    <div class="form-group col-sm-12">
        ...
        {{ Form::text('lab_manager', null, ['class' => 'form-control', 'required', 'id' => 'lab_manager', 'autocomplete' => 'off']) }}
    </div>
    <div class="form-group col-sm-12">
        {{ Form::label('general_manager', __('messages.certificate.general_manager') . ':') }}<span
            class="required">*</span>
        {{ Form::text('general_manager', null, ['class' => 'form-control', 'required', 'id' => 'general_manager', 'autocomplete' => 'off']) }}
    </div>
    <div class="form-group col-sm-12">
