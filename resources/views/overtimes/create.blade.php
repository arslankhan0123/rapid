...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.overtimes.add') }}</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    {{ Form::label('overtime_type_id', __('messages.overtimes.type') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::select('overtime_type_id', $types, null, [
                                        'class' => 'form-control',
                                        'required',
                                        'id' => 'type_select',
                                        'placeholder' => __('messages.overtimes.type'),
                                    ]) }}
                                </div>
                                <div class="form-group col-sm-12">
                                    {{ Form::label('title', __('messages.overtimes.amount') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::number('amount', null, ['class' => 'form-control', 'required', 'id' => 'bonus_name', 'autocomplete' => 'off']) }}
                                </div>
...
@section('scripts')
    ...
    <script>
        let departmentNewCreateUrl = route('overtimes.store');
