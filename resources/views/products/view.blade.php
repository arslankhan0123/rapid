        ...
        <div class="section-header item-align-right">
            ...
            <div class="float-right">
                <a href="{{ route('products.index') }}"
                    class="btn btn-primary form-btn">{{ __('messages.products.list') }}</i></a>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <strong> {{ Form::label('title_arabic', 'Service Arabic:') }}</strong>
                            <p style="color: #555;">{{ $product->title_arabic }}</p>
                        </div>
                        <div class="form-group col-md-6">
