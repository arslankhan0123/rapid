@extends('layouts.app')
@section('title')
    {{ __('messages.assets.view_category') }}
@endsection
@section('page_css')
...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.assets.view_category') }}</h1>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <strong> {{ Form::label('title', __('messages.assets.category_title')) }}</strong>
                            <p style="color: #555;">{{ $category->title }}</p>
                        </div>
