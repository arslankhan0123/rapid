...
<div class="card-body">
    ...
    <div class="row">
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            {{ Form::text('title', isset($proposal->title) ? $proposal->title : null, ['class' => 'form-control', 'required','autocomplete' => 'off','autofocus','placeholder'=> __('messages.products.title')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('proposal_number',isset($proposal->proposal_number) ? $proposal->proposal_number : generateUniqueProposalNumber() ,
                   ['class' => 'form-control', 'readonly' => 'true','placeholder'=>__('messages.proposal.proposal_number')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('date', isset($proposal->date) ? date('Y-m-d H:i:s', strtotime($proposal->date)) : null, ['class' => 'form-control datepicker', 'required', 'autocomplete' => 'off','placeholder'=>__('messages.proposal.date')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('open_till', isset($proposal->open_till) ? date('Y-m-d H:i:s', strtotime($proposal->open_till)) : null, ['class' => 'form-control due-datepicker', 'autocomplete' => 'off','placeholder'=>__('messages.proposal.open_till')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            {{ Form::label('assigned', __('messages.proposal.member').':') }}<span class="required">*</span>
            {{ Form::select('assigned_user_id', $data['users'], $proposal->assigned_user_id, ['class' => 'form-control assigned-select-box', 'autocomplete' => 'off', 'placeholder' => __('messages.placeholder.select_option'), 'required']) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <select id="proposalCurrencyId" data-show-content="true" class="form-control currency-select-box" name="currency" required>
                <option value="0" disabled="true" {{ isset($proposal->currency) ? '' : 'selected' }}>{{ __('messages.placeholder.select_currency') }}
                </option>
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            {{ Form::label('discount_type', __('messages.invoice.discount_type').':') }}<span
                    class="required">*</span>
            {{ Form::select('discount_type', $data['discountType'], isset($proposal->discount_type) ? $proposal->discount_type : null, ['class' => 'form-control','required', 'id' => 'discountTypeSelect', 'placeholder' => __('messages.placeholder.select_discount_type')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            {{ Form::label('tag', __('messages.tags').':') }}
            <div class="input-group">
                {{ Form::select('tags[]', $data['tags'], $proposal->tags->pluck('id'), ['class' => 'form-control','id' => 'tagId', 'autocomplete' => 'off', 'multiple' => 'multiple']) }}
        ...
        <div class="form-group col-lg-4 col-md-6 col-sm-12">
            ...
            {{ Form::text('hsn_tax', isset($proposal->hsn_tax) ? $proposal->hsn_tax : null, ['class' => 'form-control','placeholder'=>__('messages.invoice.hsn_tax')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            {{ Form::label('related', __('messages.proposal.related').':') }}<span class="required">*</span>
            {{ Form::select('related_to',$data['related'] , isset($proposal->related_to) ? $proposal->related_to : null, ['class' => 'form-control related-select-box', 'required','placeholder' => __('messages.placeholder.select_member')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12 related-to-field1">
            ...
            {{ Form::select('owner_id', $data['leads'], isset($proposal->owner_id) ? $proposal->owner_id : null, ['id' => 'leadOwnerId','class' => 'form-control ownerid-select-box','required', 'placeholder' => __('messages.placeholder.select_lead')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12 related-to-field2">
            ...
            {{ Form::select('owner_id', $data['customers'], isset($proposal->owner_id) ? $proposal->owner_id : null, ['id' => 'customerSelectBox','class' => 'form-control ownerid-select-box', 'required', 'placeholder' => __('messages.placeholder.select_customer')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
        ...
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <table class="table table-responsive-sm table-responsive-md table-striped table-bordered" id="itemTable">
                ...
                <tr>
                    ...
                    <th class="small-column"><span class="qtyHeader">{{ __('messages.proposal.qty') }}</span><span
                                class="required">*</span></th>
                    <th class="small-column">{{ __('messages.products.rate') }}(<i
                                data-set-currency-class="true"></i>)<span class="required">*</span>
                    </th>
                    <th class="medium-column">{{ __('messages.products.tax') }}(<i class="fas fa-percentage"></i>)</th>
                ...
                @foreach($proposal->salesItems as $item)
                    <tr>
                        <th><input type="text" name="item[]" class="form-control item-name" required
                                   value="{{ html_entity_decode($item->item) }}" placeholder="{{ __('messages.proposal.item') }}"></th>
                        <td><textarea name="description[]" class="form-control item-description"
                            placeholder="{{ __('messages.common.description') }}">{!! nl2br(e($item->description))!!}</textarea></td>
                        <td><input type="text" name="quantity[]" class="form-control qty" required min="0"
                                   value="{{$item->quantity}}" placeholder="{{  __('messages.proposal.qty') }}"></td>
                        <td><input type="text" name="rate[]" class="form-control rate" required value="{{$item->rate}}" placeholder="{{  __('messages.products.rate') }}">
                        </td>
                        <td class="">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="fDiscount form-group">
                ...
                <div class="input-group">
                    {{ Form::text('final_discount', $proposal->discount, ['class' => 'form-control footer-discount-input','placeholder'=>__('messages.proposal.discount')]) }}
        ...
        <div class="form-group col-lg-3 col-md-6 col-sm-12">
            ...
            {{ Form::number('adjustment', $proposal->adjustment, ['class' => 'form-control', 'id' => 'adjustment','placeholder'=> __('messages.proposal.adjustment')]) }}
        </div>
        <div class="form-group col-lg-3 col-md-6 col-sm-12">
