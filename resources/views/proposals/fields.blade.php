    ...
    <div class="row">
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('date', isset($proposal->date) ? $proposal->date : null, ['class' => 'form-control datepicker', 'required', 'autocomplete' => 'off','placeholder'=>__('messages.proposal.date')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <div class="input-group">
                ...
                {{ Form::text('open_till', isset($proposal->open_till) ? $proposal->open_till : null, ['class' => 'form-control due-datepicker', 'autocomplete' => 'off','placeholder'=>__('messages.proposal.open_till')]) }}
            </div>
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            {{ Form::label('assigned', __('messages.proposal.member').':') }}<span class="required">*</span>
            {{ Form::select('assigned_user_id', $data['users'], null, ['class' => 'form-control assigned-select-box', 'autocomplete' => 'off', 'placeholder' => __('messages.placeholder.select_option'), 'required']) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            <select id="proposalCurrencyId" data-show-content="true" class="form-control currency-select-box"
                ...
                <option value="0" disabled="true" selected="true">{{  __('messages.customer.currency') }}</option>
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            {{ Form::label('discount_type', __('messages.invoice.discount_type').':') }}<span
                    class="required">*</span>
            {{ Form::select('discount_type', $data['discountType'], isset($invoice->discount_type) ? $invoice->discount_type : null, ['class' => 'form-control','required', 'id' => 'discountTypeSelect', 'placeholder' =>__('messages.placeholder.select_discount_type')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
        ...
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
            ...
            {{ Form::select('related_to', $data['related'], isset($relatedTo) ? array_search($relatedTo, $data['related']) : null, ['id' => 'relatedToId', 'class' => 'form-control related-select-box','required', 'placeholder' => __('messages.placeholder.select_option')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12 related-to-field1">
            ...
            {{ Form::select('owner_id', $data['leads'], isset($proposal->owner_id) ? $proposal->owner_id : null, ['id' => 'leadOwnerId', 'class' => 'form-control ownerid-select-box','placeholder' => __('messages.placeholder.select_lead')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12 related-to-field2">
            ...
            {{ Form::select('owner_id', $data['customers'], isset($proposal->owner_id) ? $proposal->owner_id : null, ['id'=>'customerSelectBox','class' => 'form-control ownerid-select-box','required', 'placeholder' => __('messages.placeholder.select_option')]) }}
        </div>
        <div class="form-group col-lg-4 col-md-4 col-sm-12">
    ...
    <div class="row">
        <div class="form-group col-lg-12 col-md-12 col-sm-12 overflow-section">
            <table class="table table-responsive-sm table-responsive-md table-striped table-bordered">
                ...
                <tr>
                    <th><input type="text" name="item[]" class="form-control item-name" required placeholder="{{__('messages.proposal.item') }}"></th>
                    <td><textarea name="description[]" class="form-control item-description" placeholder="{{ __('messages.common.description')}}"></textarea></td>
                    <td><input type="text" name="quantity[]" class="form-control qty" required min="0" placeholder="{{__('messages.proposal.qty')}}"></td>
                    <td><input type="text" name="rate[]" class="form-control rate" required placeholder="{{ __('messages.products.rate')}}"</td>
                    <td class="">
        ...
        <div class="form-group col-sm-12">
            <div class="btn-group dropup open">
                ...
                <a href="#" class="btn btn-primary" id="saveAsDraft"
                   data-status="1">{{ __('messages.common.save') }}</a>
