    ...
    <script>
        $(document).ready(function() {
            ...
            let salesReportTable = $('#salesReportTable').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        console.log('AJAX Params:', d); // For debugging
                    }
                },
                pageLength: 10,
                lengthMenu: [
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        const rowTaxable = rowTotal - rowTax;
                    ...
                    $(api.column(5).footer()).html(taxable.toFixed(2));
                    $(api.column(6).footer()).html(tax.toFixed(2));
                    $(api.column(7).footer()).html('<b>' + total.toFixed(2) + '</b>');
                }
            });
            ...
            if (window.SpeechRecognition) {
                ...
                if (voiceBtn) {
                    ...
                    recognition.addEventListener('result', e => {
                        ...
                        salesReportTable.search(transcript).draw();
                    });
            ...
            function updateURL() {
                ...
                const newUrl = "{{ route('sales-reports.index') }}" + (queryString ? '?' + queryString : '');
            ...
            $('#filterForm').on('submit', function(e) {
                ...
                salesReportTable.ajax.reload(); // Reload table data via AJAX
            ...
            $('#btnReset').on('click', function(e) {
                ...
                window.history.pushState({}, '', "{{ route('sales-reports.index') }}");
