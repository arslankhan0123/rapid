@extends('layouts.app')
@section('title')
    {{ __('messages.sample_receiving.add') }}
@endsection
@section('page_css')
...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.sample_receiving.add') }}</h1>
            <div class="section-header-breadcrumb float-right">
                <div class="card-header-action mr-3 select2-mobile-margin">
                </div>
            </div>
            <div class="float-right">
                <a href="{{ route('sample_receiving.index') }}" class="btn btn-primary form-btn">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    ...
                    @include('sample_receiving.fields')
                    {{ Form::close() }}
...
@section('scripts')
    ...
    <script>
        let categoryUrl = route('sample_receiving.store');
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        const url = route('sample_receiving.index');
