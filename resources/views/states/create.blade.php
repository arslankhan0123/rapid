                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    {{ Form::label('title', __('messages.states.states') . ':') }}<span
                                        class="required">*</span>
                                ...
                                <div class="form-group col-sm-12 mb-0">
                                    {{ Form::label('description', __('messages.states.description') . ':') }}
...
@section('scripts')
    ...
    <script>
        let departmentNewCreateUrl = route('states.store');
