@extends('layouts.app')
@section('title')
    {{ __('messages.purchase-groups.add') }}
@endsection
@section('page_css')
...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.purchase-groups.add') }}</h1>
            <div class="section-header-breadcrumb float-right">
                <div class="card-header-action mr-3 select2-mobile-margin">
                </div>
            </div>
            <div class="float-right">
                <a href="{{ route('purchase-groups.index') }}" class="btn btn-primary form-btn">
...
@section('scripts')
    ...
    <script>
        let categoryCreateUrl = route('purchase-groups.store');
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        const url = route('purchase-groups.index');
