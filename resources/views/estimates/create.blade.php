    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <a href="{{ route('estimates.index') }}" class="btn btn-primary form-btn float-right-mobile">
...
@section('scripts')
                ...
                if (selectedValue && selectedText) {
                    ...
                    if ($('#terms_table tbody').find(`tr[data-id="${selectedValue}"]`).length === 0) {
                        ...
                        <tr data-id="${selectedValue}" class='mt-1'>
                            <td>${termIndex}</td>
                            <td class='p-0 m-0'> <textarea name="description[]" class='form-control' style='height:120px;width:100%;' >${selectedText}</textarea><input type='hidden' name='terms[]' value="${selectedValue}" </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            let rowIndex = 1;
            calculateRow($('#itemRows tr[data-index="0"]'));
            calculateTotals();
            ...
            function addRow() {
                ...
                <tr data-index="${rowIndex}">
                    ...
                    <td class="p-1 text-right">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="headlineModal_${rowIndex}" tabindex="-1" role="dialog" style="text-align: left;">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="itemsArr[${rowIndex}]['headline']">
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" name="itemsArr[${rowIndex}]['subheadline']" style="height: 150px;"></textarea>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).on('click', '.openHeadlineModal', function() {
