<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-2 col-sm-12">
            {{ Form::label('admin_note', 'Branch') }}<span class="required">*</span>
            {{ Form::select('branch_id', ['' => 'Select Branch'] + ($usersBranches?->toArray() ?? []), $estimate->branch_id ?? null, ['class' => 'form-control select2', 'required', 'id' => 'branchSelect']) }}
        </div>
        ...
        {{-- New Quality No field --}}
        <div class="form-group col-md-2 col-sm-12">
            {{ Form::label('quality_no', 'Quality No') }}
            {{ Form::text('quality_no', null, ['class' => 'form-control', 'maxlength' => 50]) }}
        </div>

        {{-- Make Subject smaller so row doesn’t overflow --}}
        <div class="form-group col-md-2 col-sm-12">
