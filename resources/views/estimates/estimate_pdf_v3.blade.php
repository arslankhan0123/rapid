    ...
    <main>
        <div class="content_info">
            <table border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="width: 2cm;">Qoute No</td>
                    <td style="width: 1.22cm;">{{ $estimate->estimate_number }}</td>
                    <td style="width: 2cm;">Qoute Date</td>
                    <td style="width: 2cm;">{{ \Carbon\Carbon::parse($estimate->estimate_date)->format('d-m-Y') }}</td>
                    <td style="width: 2cm;">Qoute Validity</td>
                    <td style="width: 3cm;">{{ \Carbon\Carbon::parse($estimate->estimate_date)->format('d-m-Y') }}
                    </td>
                    <td style="width: 2.1cm;">Cust. Reference</td>
                ...
                <tr>
                    ...
                    <td style="width: 2cm;word-wrap: break-word; overflow-wrap: break-word; white-space: normal;">Email
                    </td>
                    <td style="width: 1.9cm;word-wrap: break-word; overflow-wrap: break-word; white-space: normal;">
                        {{ $estimate->customer->email ?? 'N/A' }}</td>
                    <td>Address</td>
                ...
                <tr>
                    <td style="width:2cm;">Subject</td>
                    <td colspan="3">{{ $estimate->admin_note ?? '' }}</td>
                    <td style="width:2cm;">Quality No</td>
                    <td colspan="3">{{ $estimate->quality_no ?? '' }}</td>
                    <td>Branch</td>
                    <td>{{ $estimate->branch?->name ?? '' }}</td>
                    <td>Vendor Code</td>
                    <td>{{ $estimate->vendor_code ?? '' }}</td>
                </tr>
                <tr>
