...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.job_sources.add') }}</h1>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 mb-0">
                                    {{ Form::label('description', __('messages.job_sources.description') . ':') }}
...
@section('scripts')
    ...
    <script>
        let departmentNewCreateUrl = route('job-sources.store');
