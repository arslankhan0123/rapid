            ...
            <div class="card">
                <div class="card-body">
                    <div class="modal-content">
                        {{ Form::open(['route' => 'job-positions.store', 'id' => 'createJobPositionForm']) }}
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    {{ Form::select('skills[]', $skills, null, ['class' => 'form-control select2', 'id' => 'skills', 'multiple' => 'multiple', 'data-placeholder' => 'Select Required Skills']) }}
                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('submit', '#createJobPositionForm', function(event) {
            event.preventDefault();
            processingBtn('#createJobPositionForm', '#btnSave', 'loading');
            ...
            if ($('#createDescription').summernote('isEmpty')) {
                ...
                processingBtn('#createJobPositionForm', '#btnSave', 'reset');
                return false;
            }
            ...
            $.ajax({
                ...
                complete: function() {
                    processingBtn('#createJobPositionForm', '#btnSave');
                },
            });
        });
    </script>
