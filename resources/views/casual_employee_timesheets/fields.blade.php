...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        {!! Form::date('timesheet_date', null, ['class' => 'form-control', 'required']) !!}
    </div>
    <div class="form-group col-sm-6">
        {!! Form::label('month_year', __('Monthly Timesheet Month') . ':') !!}
        {!! Form::month('month_year', null, ['class' => 'form-control', 'required']) !!}
    </div>
...
<div class="row mt-4">
    <div class="col-md-12 text-right">
        ...
        {!! Form::submit(__('Save'), ['class' => 'btn btn-primary btn-lg px-4']) !!}
    </div>
</div>
