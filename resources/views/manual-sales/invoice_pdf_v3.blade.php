        ...
        <div class="content_info">
            <table border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="width: 2.40cm;">Payment Modes</td>
                    <td style="width:2cm;">
                        <p>
                            @forelse($invoice->paymentModes as $paymentMode)
                                <span class="badge badge-light mb-1">{{ html_entity_decode($paymentMode->name) }}
                                </span>
                            @empty
                ...
                <tr>
                    ...
                    <td
                        style="width: 2cm; max-width: 2cm; word-wrap: break-word; word-break: break-word; white-space: normal;">
                ...
                <tr>
                    <td style="width: 2cm;">Vendor Code</td>
