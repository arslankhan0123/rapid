                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    {{ Form::label('country_id', __('messages.areas.country') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::select('country_id', $countries, null, ['class' => 'form-control', 'required', 'id' => 'country_select', 'placeholder' => __('messages.states.select_country')]) }}
                                </div>

                                <div class="form-group col-sm-12">
                                    {{ Form::label('state_id', __('messages.areas.state') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::select('state_id', [], null, ['class' => 'form-control', 'required', 'id' => 'state_select', 'placeholder' => __('messages.areas.select_state')]) }}
                                </div>

                                <div class="form-group col-sm-12">
                                    {{ Form::label('city_id', __('messages.areas.city') . ':') }}<span
                                        class="required">*</span>
                                    {{ Form::select('city_id', [], null, ['class' => 'form-control', 'required', 'id' => 'city_select', 'placeholder' => __('messages.states.select_city')]) }}
                                </div>

                                <div class="form-group col-sm-12 mb-0">
                                    {{ Form::label('description', __('messages.areas.description') . ':') }}
...
@section('scripts')
    ...
    <script>
        let departmentNewCreateUrl = route('areas.store');
