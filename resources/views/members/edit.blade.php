...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            // Password show/hide for edit form
            $("#show_hide_edit_password button").on('click', function(event) {
            ...
            $("#show_hide_edit_cPassword button").on('click', function(event) {
                event.preventDefault();
                const passwordInput = $('#edit_cPassword');
                const icon = $(this).find('i');
