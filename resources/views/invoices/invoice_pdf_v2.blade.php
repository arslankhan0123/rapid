...
<body>
    <!-- Header -->
    <header>
        <img src="{{ $headerImage }}" style="width: 100%;height:2.96cm; padding: 0px;">
    ...
    <main>
            ...
            <table border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="width: 1.22cm;">
                        {{ \Carbon\Carbon::parse($invoice->due_date)->diffInDays(\Carbon\Carbon::parse($invoice->invoice_date)) }}
                    </td>
                ...
                <tr>
                    <td style="width: 2cm;">Project Code </td>
                    <td style="width: 1.22cm;">12541</td>
                    <td style="width: 2cm;">Project Location</td>
                    <td style="width: 2cm;">{{ $invoice->project->project_location ?? 'N/A' }}</td>
                    <td style="width: 2.48cm;">Email</td>
                    <td style="width: 3.36cm;">{{ $invoice->customer->email ?? 'N/A' }}</td>
                    <td style="width: 2.40cm;">Address</td>
                    <td style="width:2cm;">
        ...
        <table style="width: 100%; text-align: center;margin-top:30px;">
            <tr>
                <th style="width: 33.33%;">Signature __________________</th>
                <th style="width: 33.33%;">Date __________________</th>
                <th style="width: 33.33%;">Stamp __________________</th>
            </tr>
            <tr>
