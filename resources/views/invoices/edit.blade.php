...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            let rowIndex = $('#itemRows tr').not('.sales-items-empty-placeholder').length;
            ...
            function addRow() {
                ...
                rowIndex = $('#itemRows tr').not('.sales-items-empty-placeholder').length;
            ...
            $(document).on('click', '.remove-row', function() {
                ...
                if ($('#itemRows tr').not('.sales-items-empty-placeholder').length === 0) {
                    rowIndex = 0;
                    $('#itemRows').append(
                        '<tr class="sales-items-empty-placeholder"><td colspan="12" class="text-center">No items found</td></tr>'
                    );
                }
                calculateTotals();
            });
