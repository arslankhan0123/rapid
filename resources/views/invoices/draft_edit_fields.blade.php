...
<div class="card-body">
        ...
        @else
            <div class="form-group col-md-2 col-sm-12">
                ...
                <div class="input-group">
                    ...
                    {{ Form::text('invoice_date', isset($invoice->invoice_date) ? date('Y-m-d', strtotime($invoice->invoice_date)) : null, ['class' => 'form-control invoiceDate', 'required', 'readonly', 'autocomplete' => 'off', 'placeholder' => __('messages.invoice.invoice_date')]) }}
                </div>
            </div>
        @endif

        {{ Form::hidden('payment_status', $invoice->payment_status, ['id' => 'invoiceStatus']) }}
        {{ Form::hidden('force_today_date', 0, ['id' => 'forceTodayDate']) }}
    ...
    <br>
    @include('invoices.draft_edit_items')
    <hr />
    <br />
