            ...
            <div class="card">
                <div class="card-body">
                    <div class="modal-content">
                        {{ Form::open(['route' => 'job-skills.store', 'id' => 'createJobSkillForm']) }}
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('submit', '#createJobSkillForm', function(event) {
            event.preventDefault();
            processingBtn('#createJobSkillForm', '#btnSave', 'loading');
            ...
            if ($('#createDescription').summernote('isEmpty')) {
                ...
                processingBtn('#createJobSkillForm', '#btnSave', 'reset');
                return false;
            }
            ...
            $.ajax({
                ...
                complete: function() {
                    processingBtn('#createJobSkillForm', '#btnSave');
                },
            });
        });
    </script>
