                            ...
                            <div class="content_body">
                                ...
                                <table class="salary_info">
                                    ...
                                    <tr>
                                        ...
                                        <td class="earnings-column"></td>
                                        <td class="deductions-column text-right">
                                            {{ number_format($salarySheet->total_insurance ?? 0, 2) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="total-row">
                                        ...
                                        <td class="earnings-column text-right">
                                            {{ number_format($salarySheet->gross_salary, 2) }}
                                        </td>
                                        <td class="deductions-column text-right">
                                            {{ number_format($salarySheet->total_deduction + $salarySheet->salary_advance + $salarySheet->total_insurance + $salarySheet->loan + $salarySheet->hourly_deduction, 2) }}
                                        </td>
                                    </tr>
                                    <tr>
