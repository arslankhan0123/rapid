@php
    ...
    $perDayAllowance = $allowancesTotal / 30;
    $perHourAllowance = $perDayAllowance / 8;
    $allowanceDeduction = $perHourAllowance * $salarySheet->absence_hours;
    $manualDeduction = $salarySheet->total_deduction - $salarySheet->hourly_deduction;
    $totalDeductionsSum = $salarySheet->salary_advance + $salarySheet->loan + $salarySheet->hourly_deduction + $salarySheet->total_insurance + $allowanceDeduction + $manualDeduction;
    $grossSalarySum = $salarySheet->basic_salary + $salarySheet->total_bonus + $allowancesTotal + $salarySheet->total_overtimes;
...
<body>
    ...
    <div class="contents">
        <div class="content_header">
            ...
            <div class="right">
                <h1 style="font-size: 20pt;">NET PAY<br>{{ number_format($salarySheet->net_salary ?? 0, 2) }}</h1>
            </div>
        </div>
            ...
            <table class="salary_info">
                ...
                <tr>
                    ...
                    <td class="earnings-column text-right">
                        {{ number_format($salarySheet->basic_salary ?? 0, 2) }}</td>
                    <td class="deductions-column"></td>
                </tr>
                <tr>
                    <td colspan="2">HRA</td>
                    <td class="earnings-column text-right"> {{ number_format($allowancesTotal ?? 0, 2) }}
                    </td>
                    <td class="deductions-column"></td>
                </tr>
                @foreach ($allowances as $allowance)
                    <tr>
                        <td colspan="2" class="textLeftPadding">
                            {{ $allowance['type'] }}
                            <span style="float: right;  padding: 0 5px;">{{ $allowance['total_amount'] }}</span>
                        </td>
                ...
                {{-- <tr>
                    <td colspan="2" class="textLeftPadding">Vehicle</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column"></td>
                </tr>
                <tr>
                    <td colspan="2" class="textLeftPadding">Technical</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column"></td>
                </tr>
                <tr>
                    <td colspan="2" class="textLeftPadding">Food</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column"></td>
                </tr>
                <tr>
                    <td colspan="2" class="textLeftPadding">Communication</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column"></td>
                </tr>
                <tr>
                    <td colspan="2" class="textLeftPadding">Transportation</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column"></td>
                </tr> --}}
                <tr>
                    <td colspan="2">Bonus Pay</td>
                    <td class="earnings-column text-right"> {{ number_format($salarySheet->total_bonus ?? 0, 2) }}</td>
                    <td class="deductions-column"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="earnings-column"></td>
                    <td class="deductions-column text-right">{{ number_format($salarySheet->loan ?? 0, 2) }}</td>
                </tr>
                <tr>
                    <td colspan="2">Advance Repayment</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column text-right">{{ number_format($salarySheet->salary_advance ?? 0, 2) }}
                    </td>
                </tr>
                <tr>
                    <td colspan="2">Insurance Amount</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column text-right">{{ number_format($salarySheet->total_insurance ?? 0, 2) }}</td>
                </tr>
                <tr>
                    <td colspan="2">Allowance Deduction</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column text-right">{{ number_format($allowanceDeduction ?? 0, 2) }}</td>
                </tr>
                <tr>
                    <td colspan="2">Other Deduction</td>
                    <td class="earnings-column"></td>
                    <td class="deductions-column text-right">{{ number_format($manualDeduction ?? 0, 2) }}
                    </td>
                </tr>
                <tr class="total-row">
                    <td colspan="2" class="text-right">Total</td>
                    <td class="earnings-column text-right">
                        {{ number_format($grossSalarySum, 2) }}</td>
                    <td class="deductions-column text-right">
                ...
                <tr>
                    ...
                    <td colspan="2" style="text-align:center;">
                        ...
                        <p style="font-size:12pt;">(Earnings-Deductions)</p>
