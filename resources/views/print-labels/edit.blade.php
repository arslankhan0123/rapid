                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            {{ Form::text('code', $item->code ?? null, ['class' => 'form-control', 'required', 'autocomplete' => 'off', 'readonly']) }}
                        </div>
                        <div class="form-group col-sm-12 col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            {{ Form::label('title', __('messages.purchase-items.short_name') ) }}<span class="required">*</span>
                            {{ Form::text('name', $item->name, ['class' => 'form-control', 'required', 'id' => 'categoryTitle_edit', 'autocomplete' => 'off',"maxLength"=>20]) }}
                        </div>
                        <div class="form-group col-md-6">
                            {{ Form::label('title', __('messages.purchase-items.full_name') ) }}<span class="required">*</span>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            {{ Form::label('purchase_sub_category_id', __('messages.purchase-items.name') ) }}<span
                                class="required">*</span>
                            <select class="form-control select2" required id="subcategory_select"
                        ...
                        <div class="form-group col-sm-12 mb-0">
                            ...
                            {{ Form::textarea('description', $item->description, ['class' => 'form-control summernote-simple', 'id' => 'editCategoryDescription']) }}
                        </div>
                    </div>
