...
<body>
    ...
    <table style="width: 100%; margin-bottom: 10px; margin-left: 12px;margin-top:10px;">
        <tr>
            ...
            <td style="vertical-align: middle;">
                <div style="font-size: 7pt; font-weight: bold;">{!! $compnayName !!}</div>
            </td>
        </tr>
    </table>
    ...
    <table style="width: 50%;  margin: 10px auto 0 auto; font-size: 10px; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td>:</td>
            <td style="padding: 4px; word-wrap: break-word; word-break: break-all; white-space: normal;width:100px;max-width:100px;">
                {{ $employee->email ?? '-' }}
            </td>
        </tr>
        <tr>
