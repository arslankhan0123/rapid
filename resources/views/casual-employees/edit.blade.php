...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.casual_employees.edit_employee') }}</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        {{ Form::label('title', __('messages.employees.employee_name') . ':') }}<span
                                            class="required">*</span>
                                        {{ Form::text('name', $employee->name, ['class' => 'form-control letters-only', 'required', 'id' => 'productUnit_title', 'autocomplete' => 'off', 'placeholder' => __('messages.employees.employee_name')]) }}
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12 col-md-3">
                                        ...
                                        {{ Form::number('basic_salary', $employee->basic_salary, ['class' => 'form-control positive-int', 'id' => 'basic_salary', 'min'=>'0', 'step'=>'1', 'autocomplete' => 'off']) }}
                                    </div>
                                    {{-- <div class="form-group col-sm-12 col-md-3">
                            ...
                            <div class="modal-body employeeForm">
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        {{ Form::text('bank_name', $employee->bank_name, ['class' => 'form-control letters-only', 'id' => 'bank_name', 'autocomplete' => 'off']) }}
                                    </div>
                                    <div class="form-group col-sm-12 col-md-6">
                                        {{ Form::label('branch_name', __('messages.employees.branch_name') . ':') }}
                                        {{ Form::text('branch_name', $employee->branch_name, ['class' => 'form-control letters-only', 'id' => 'branch_name', 'autocomplete' => 'off']) }}
                                    </div>
                                    <div class="form-group col-sm-12 col-md-6">
    ...
    @section('scripts')
        ...
        <script>
            $(document).on('submit', '#editForm', function(event) {
                ...
                $.ajax({
                    url: route('casual.employees.update', id),
                    type: 'POST',
                    data: formData,
