                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 date-field">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6 col-md-6 other_field">
                                    <div class="form-group">
                                        {{ Form::label('paid Leave Days', __('messages.leave-applications.paid_leave_days')) }}
                                        {{ Form::number('paid_leave_days', 0, ['class' => 'form-control', 'required', 'id' => 'paid_leave_days', 'autocomplete' => 'off']) }}
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 other_field">
                                    <div class="form-group">
                                        {{ Form::label('paid Leave Days', __('messages.leave-applications.paid_leave_amount')) }}
                                        {{ Form::number('paid_leave_amount', 0, ['class' => 'form-control', 'id' => 'paid_leave_amount', 'required', 'autocomplete' => 'off', 'readonly']) }}
                                    </div>
                                </div>

                                <div class="col-lg-6 col-md-6 other_field">
                                    <div class="form-group">
                                        {{ Form::label('paid Leave Days', __('messages.leave-applications.ticket_amount')) }}<span
                                            class="required">*</span>
                                        {{ Form::number('ticket_amount', null, ['class' => 'form-control', 'id' => 'ticket_amount', 'required', 'autocomplete' => 'off']) }}
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 other_field">
                                    <div class="form-group">
                                        {{ Form::label('paid Leave Days', __('messages.leave-applications.claim_amount')) }}
                                        {{ Form::number('claim_amount', 0, ['class' => 'form-control', 'id' => 'claim_amount', 'required', 'autocomplete' => 'off', 'readonly']) }}
                                    </div>
                                </div> --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#paid_leave_days").on('input', function() {
                ...
                var selectedEmployeeId = $("#employee_select").val();
                var employee = employees.find(emp => emp.id == selectedEmployeeId);
                if (employee) {
    ...
    <script>
        $(document).ready(function() {
            function toggleDateFields() {
                let selectedText = $('#leave_type option:selected').text().trim().toLowerCase();

                if (selectedText === 'annual leave') {
                    $(".other_field").show();
                 //   $('.date-field').hide();
                    $('#from_date, #end_date').prop('required', false);
                    //   $('#ticket_amount').prop('required', true);
                } else {
                    $('.date-field').show();
                    $('#from_date, #end_date').prop('required', true);
                    $(".other_field").hide();
