...
@section('content')
    <section class="section">
        <div class="section-header item-align-right">
            <h1>{{ __('messages.transfers.edit') }}</h1>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    ...
                    {{ Form::hidden('id', $transfer->id, ['id' => 'bonus_id']) }}
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            {{ Form::label('approved_date', __('messages.common.date') . ':') }}<span
                                class="required">*</span>
                            {{ Form::date('transfer_date', $transfer->transfer_date ?? null, ['class' => 'form-control', 'required']) }}
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            {{ Form::label('bonus_type_id', __('messages.transfers.from') . ':') }}<span
                                class="required"></span>
                            {{ Form::select('from', $usersBranches, $transfer->from ?? null, [
                                'class' => 'form-control',
                                'id' => 'from_branch',
                        ...
                        <div class="form-group col-sm-12">
                            {{ Form::label('bonus_type_id', __('messages.transfers.to') . ':') }}<span
                                class="required">*</span>
                            {{ Form::select('to', $usersBranches, $transfer->to ?? null, [
                        ...
                        <div class="form-group col-sm-12 mb-0">
                            ...
                            {{ Form::textarea('description', $transfer->description, ['class' => 'form-control summernote-simple', 'id' => 'createDescription']) }}
                        </div>
                    </div>
