@extends('layouts.app')
@section('title')
    {{ __('messages.safety_materials.edit_safety_material') }}
@endsection
@section('page_css')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ __('messages.safety_materials.edit_safety_material') }}</h1>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($safetyMaterial, [
                        'route' => ['safety-materials.update', $safetyMaterial->id],
                        'method' => 'put',
                        'id' => 'editSafetyMaterialForm',
                    ]) !!}
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#editSafetyMaterialForm').on('submit', function(e) {
                e.preventDefault();
                let $btn = $('#btnSave');
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (errors) {
                            ...
                            alert(xhr.responseJSON?.message || 'Error updating data');
                        }
                        $btn.html('{{ __('messages.common.submit') }}').attr('disabled',
                            false);
                    }
