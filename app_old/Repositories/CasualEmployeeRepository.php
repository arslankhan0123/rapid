 ...
 */
class CasualEmployeeRepository extends BaseRepository
{
    /**
     * @var array
     */
    ...
    public function create($input)
    {
        ...
        try {
            ...
            $employee = CasualEmployee::create($data);
            // dd($employee);
    ...
    {
        return  CasualEmployee::where('id', $id)->first();
    }
    ...
    public function getEmployeesByStatus($branch = null)
    {
        $query = CasualEmployee::with(['branch'])
