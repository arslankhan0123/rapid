 ...
 */
class PurchasePaymentListRepository extends BaseRepository
{
    /**
     * @var array
     */
    ...
    public function create($input)
    {
        ...
        try {
            ...
            $payment = PurchasePayment::create(Arr::only($input, $this->getFieldsSearchable()));
            $invoice = PurchaseInvoice::findOrFail($payment->owner_id);

            $totalPayments = PurchasePayment::where('owner_id', $payment->owner_id)->sum('amount_received');
    ...
    public function getInvoices($isEdit = null)
    {
        ...
        return PurchaseInvoice::with('payments')->get();
    }
    ...
    public function deletePayment($payment)
    {
        ...
        try {
            ...
            $totalPayments = PurchasePayment::where('owner_id', $ownerId)->sum('amount_received');
