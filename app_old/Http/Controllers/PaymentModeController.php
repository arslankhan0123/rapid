...
class PaymentModeController extends AppBaseController
{
    ...
    public function store(CreatePaymentModeRequest $request)
    {
        ...
        return $this->sendResponse($paymentMode, __('messages.payment_mode.payment_mode_saved_successfully'));
    }
    ...
    public function update(PaymentMode $paymentMode, UpdatePaymentModeRequest $request)
    {
        ...
        return $this->sendSuccess(__('messages.payment_mode.payment_mode_updated_successfully'));
    }
    ...
    public function destroy(PaymentMode $paymentMode)
    {
        ...
        if ($invoicePaymentMode) {
            return $this->sendError(__('messages.payment_mode.payment_mode_used_somewhere_else'));
        }
