...
class UpdateSupplierRequest extends FormRequest
{
    ...
    {
        $supplierId = $this->route('supplier'); // adjust if your route model binding uses different key
        ...
        return [
            ...
            'vat_number'       => [
                ...
                'min:4',
                'max:15',
                // example if vat_number must be unique:
                Rule::unique('suppliers', 'vat_number')->ignore($supplierId),
            ],
    ...
    public function messages()
    {
        return [
            ...
            'vat_number.unique'     => 'This VAT number already exists.',
